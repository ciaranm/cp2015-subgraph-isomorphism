...
Our algorithm was implemented\footnote{source code, data and experimental scripts available at\\
\url{https://github.com/ciaranm/cp2015-subgraph-isomorphism}}in C++ using C++11 native threads, and
was compiled using GCC 4.9.0.  We performed our experiments on a machine with dual Intel Xeon
