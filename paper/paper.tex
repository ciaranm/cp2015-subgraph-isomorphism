...
12ms onwards. Finally, removing supplemental graphs from our algorithm gives an improvement below 1s
(due to the cost of preprocessing), but is beneficial for longer runtimes.
