...
plot \
    "graph-backjumping.data" u (($2 == 0 && $3 == 10) ? ($5<1?1:$5) : NaN):($6<1?1:$6):(1) ps variable pt 5 lc 2 notitle, \
    "graph-backjumping.data" u (($2 == 1 && $3 == 10) ? ($5<1?1:$5) : NaN):($6<1?1:$6):(1) ps variable pt 4 lc 2 notitle, \
    ...
    "graph-backjumping.data" u (($2 == 1 && $3 == 3) ? ($5<1?1:$5) : NaN):($6<1?1:$6):(1) ps variable pt 1 lc 3 notitle, \
    "graph-backjumping.data" u (($2 == 1 && $3 == 4) ? ($5<1?1:$5) : NaN):($6<1?1:$6):(1) ps variable pt 1 lc 3 notitle, \
    "graph-backjumping.data" u (($2 == 1 && $3 == 5) ? ($5<1?1:$5) : NaN):($6<1?1:$6):(1) ps variable pt 2 lc 5 notitle, \
    "graph-backjumping.data" u (($2 == 1 && $3 == 6) ? ($5<1?1:$5) : NaN):($6<1?1:$6):(1) ps variable pt 2 lc 5 notitle, \
    ...
    "graph-backjumping.data" u (($2 == 1 && $3 == 7) ? ($5<1?1:$5) : NaN):($6<1?1:$6):(1) ps variable pt 3 lc 8 notitle, \
    "graph-backjumping.data" u (($2 == 0 && $3 == 8) ? ($5<1?1:$5) : NaN):($6<1?1:$6):(1) ps variable pt 9 lc 6 notitle, \
    "graph-backjumping.data" u (($2 == 1 && $3 == 8) ? ($5<1?1:$5) : NaN):($6<1?1:$6):(1) ps variable pt 8 lc 6 notitle, \
    "graph-backjumping.data" u (($2 == 1 && $3 == 9) ? ($5<1?1:$5) : NaN):($6<1?1:$6):(1) ps variable pt 12 lc 4 notitle, \
    "graph-backjumping.data" u (($2 == -1 && ($5 < 1e8 || $6 < 1e8)) ? ($5<1?1:$5) : NaN):($6<1?1:$6) pt 2 lc 0 ps 10 notitle, \
