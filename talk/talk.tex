...
\begin{frame}{Selected Previous Work}
    \begin{itemize}
        \item \textcolor{uofgthistle}{VF2}: backtracking search, interesting heuristics. Widely used. \\[0.1cm]
        ...
        \item \textcolor{uofgthistle}{LAD}: locally all-different, and neighbourhood degree sequences. \\[0.1cm]
            {\scriptsize AllDifferent-based filtering for subgraph isomorphism. \emph{Christine
                Solnon}.  Artif. Intell., 2010.}

        \item \textcolor{uofgthistle}{SND}: distance-based filtering. \\[0.1cm]
...
\begin{frame}{Being Clever is Expensive}
    \begin{itemize}
        ...
        \item When LAD and SND fail, they often manage less than \textcolor{uofgthistle}{one
